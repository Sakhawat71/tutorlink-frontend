...
// import { signupSchema } from "./signupValidation"; // Adjust path as needed
...
export const StudentSignupForm = () => {
    ...
    const handleSocialLogin = (provider: string) => {
        signIn(provider, { callbackUrl: "/dashboard" }); // Pass role to social login
    };
        ...
        <div className={cn("flex flex-col gap-6")}>
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Join TutorLink with your Google or GitHub account
                    </CardDescription>
                </CardHeader>
                <CardContent>
