        ...
        <div className="flex flex-col h-full max-w-md rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="px-6 py-4 bg-white border-t border-gray-100">
                ...
                <div className="flex space-x-3">
                    <Link href="/" className="flex-1 bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-50 py-2 px-4 rounded-lg font-medium transition-colors text-center">
                        Book Session
                    </Link>
                </div>
            </div>
