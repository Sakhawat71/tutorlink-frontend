...
export const TutorCard = ({ tutor }: TutorCardProps) => {
    ...
    return (
        <div className="max-w-md rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="ml-5 flex-1">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm mt-1">{tutor.subjectList.join(", ")}</p>
                        </div>
                    ...
                    <div className="mt-3 flex items-center text-sm text-gray-500">
                        ...
                        {tutor.location === "ONLINE" ? "Online Tutoring" : "In-Person Tutoring"}
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
                <p className="text-gray-700 line-clamp-3">{tutor.bio}</p>
            </div>
            ...
            <div className="px-6 py-4 bg-white border-t border-gray-100">
                <div className="flex items-center text-sm text-gray-600 mb-3">
                    ...
                    <span className="ml-1">{availabilitySummary || "Not specified"}</span>
                </div>

                <div className="flex space-x-3">
                    <button className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg font-medium transition-colors">
                        Message Tutor
                    </button>
